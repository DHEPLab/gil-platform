...
const swaggerSpec = swaggerJsdoc({
  definition: {
    openapi: "3.0.0",
    info: {
      title: "CollectiveGood API",
      version: "1.0.0",
      description:
        "OpenAPI documentation for the CollectiveGood backend – covering Auth, Users, Cases, Assignments, and Responses.",
    },
    servers: [
  ...
  res.send(`
    ...
    <html lang="en">
      <head>
        ...
        <title>CollectiveGood API Documentation</title>
